...
/** デフォルトコンストラクタ */
SDimStdArray::SDimStdArray() {}

/**
 * 初期化する．
 */
void SDimStdArray::Init() {
 ...
 * @return タグ名
 */
std::string SDimStdArray::Tag() const {
 ...
 * @return 実行結果．
 */
double SDimStdArray::GetResult(std::size_t i, std::size_t j) const {
