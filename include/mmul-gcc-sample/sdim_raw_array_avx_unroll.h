#ifndef MMUL_GCC_SAMPLE_SDIM_RAW_ARRAY_AVX_UNROLL_H_
#define MMUL_GCC_SAMPLE_SDIM_RAW_ARRAY_AVX_UNROLL_H_
 ...
 */
class SDimRawArrayAVXUnroll :
  public MatrixMul,
  public Executable {
public:
  /** デフォルトコンストラクタ */
  SDimRawArrayAVXUnroll();
...
#endif // MMUL_GCC_SAMPLE_SDIM_RAW_ARRAY_AVX_UNROLL_H_
